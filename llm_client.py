...
1. If the context fully or partially supports an answer, answer clearly and concisely in plain language, and cite which chunk(s) you used like this: (Source: Chunk 2).
